...
export const getRuntimeConfig = (): RuntimeConfig => {
  ...
  cachedConfig = {
    supabaseUrl: clientEnv.data.NEXT_PUBLIC_SUPABASE_URL ?? FALLBACK_SUPABASE_URL,
    supabaseAnonKey: clientEnv.data.NEXT_PUBLIC_SUPABASE_ANON_KEY ?? FALLBACK_SUPABASE_ANON_KEY,
